...
cd /opt/root
wget http://ndm.zyxmon.org/binaries/debian/debian-bookworm-12.13-mipsel.tar.gz
# Создаем директорию и распаковываем Debian
mkdir -p /opt/debian
tar -xzf /opt/root/debian-bookworm-12.13-mipsel.tar.gz -C /opt/debian
...
``` 
debian
cd /roothttps://raw.githubusercontent.com/pegakmop/debian-keenetic/refs/heads/master/EOL/ndmq-mipsel_buster.tgz
wget 
tar -xzf ndmq-mipsel_buster.tgz -C /
