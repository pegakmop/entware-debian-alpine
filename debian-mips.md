...
cd /opt/root
wget http://ndm.zyxmon.org/binaries/debian/debian-buster-10.13-mips.tar.gz
# Создаем директорию и распаковываем Debian
mkdir -p /opt/debian
tar -xzf /opt/root/debian-buster-10.13-mips.tar.gz -C /opt/debian
...
``` 
debian
cd /roothttps://raw.githubusercontent.com/pegakmop/debian-keenetic/refs/heads/master/EOL/ndmq-mips_buster.tgz
wget 
tar -xzf ndmq-mips_buster.tgz -C /
